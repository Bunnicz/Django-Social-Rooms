...
def loginPage(request):  # Cant be just login - buildIn function
    page = "login"
...
def createRoom(request):
    ...
    if request.method == "POST":
        ...
        # if form.is_valid():
        #     # excluded host choice from form, need to save host first before commit
...
def updateUser(request):
    ...
    # Update user profile form (data and avatar)
    if request.method == "POST":
